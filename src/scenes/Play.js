class Play extends Phaser.Scene{
    ...
    create(){
        ...
        //add rocket (p1)
        this.p1Rocket = new Rocket(this, game.config.width/2, game.config.height - borderUISize - borderPadding, 'rocket', 0, 1).setOrigin(0,0);
        //add rocket (p2)
        this.p2Rocket = new Rocket(this, game.config.width/4, game.config.height - borderUISize - borderPadding, 'octopus', 0, 2).setOrigin(0,0);
        //add spaceships (x3)
